...
Windows, WinGDK, Linux, Mac, PS5, and Xbox hardware models can be represented
...
4. Build an UE4SS server probe that logs the runtime platform value without
   kicking anyone.
5. Enable kicks only after Steam, WinGDK, Linux, Mac, Xbox console, and PS5
   observations are validated on the target game build.
