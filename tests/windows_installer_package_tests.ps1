...
Require-Text $launcherSource 'launcher_version = "1.0.30"' `
...
Require-Text $releaseManifest '"launcherVersion": "1.0.30"' `
    "stable manifest must trigger the managed PalHud payload update"
Require-Text $releaseManifest '"minimumLauncherVersion": "1.0.30"' `
