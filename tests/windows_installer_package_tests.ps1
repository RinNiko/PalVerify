...
Require-Text $launcherSource 'launcher_version = "1.0.29"' `
    "launcher must ship the managed PalHud payload revision"
Require-Text $palHudSource 'local VERSION = "1.4.5"' `
    "launcher must bundle PalHud v1.4.5"
...
Require-Text $launcherSource 'palverify_version = "1.0.14"' `
    "launcher must bundle PalVerify verifier version 1.0.14"
...
Require-Text $releaseManifest '"launcherVersion": "1.0.29"' `
    "stable manifest must trigger the managed PalHud payload update"
Require-Text $releaseManifest '"minimumLauncherVersion": "1.0.29"' `
...
Require-Text $packageInfo '"Version": "1.0.14"' `
    "PalVerify package metadata must expose verifier version 1.0.14"
Require-Text $clientAgentSource 'CLIENT_STARTED protocol=3 version=1.0.14' `
    "client runtime log must expose verifier version 1.0.14"
