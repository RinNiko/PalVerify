...
Require-Text $launcherSource 'launcher_version = "1.0.22"' `
    "launcher must use the stable UE4SS parent digest revision"
...
Require-Text $launcherSource 'palverify_version = "1.0.13"' `
    "launcher must bundle PalVerify verifier version 1.0.13"
...
Require-Text $releaseManifest '"launcherVersion": "1.0.22"' `
    "stable manifest must trigger the stable UE4SS parent digest update"
Require-Text $releaseManifest '"minimumLauncherVersion": "1.0.22"' `
    "stable manifest must require the stable UE4SS parent digest revision"
...
Require-Text $packageInfo '"Version": "1.0.13"' `
    "PalVerify package metadata must expose verifier version 1.0.13"
Require-Text $clientAgentSource 'CLIENT_STARTED protocol=3 version=1.0.13' `
    "client runtime log must expose verifier version 1.0.13"
